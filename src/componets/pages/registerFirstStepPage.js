  ...
  return (
    <Wrap>
      ...
      <TouchableOpacity style={{width: "80%"}} onPress={() => {
        if (lastNameValue != '' && firstNameValue != '' && patronymicValue != '' && genderValue != undefined) {
          funcToChangeData({
        ...
        <BtnWrapper bgColor={lastNameValue != '' && firstNameValue != '' && patronymicValue != '' && genderValue != undefined ? "rgba(160, 192, 250, 1)" : "rgba(160, 192, 250, 0.5)"}>
